...
def water_level():
    ...
    distance = distance / 2
    # Constant is the depth of the of what the water is in
    # Constant will vary depending on depth of pipe or container
    water_level = (12.9 - 2.3) - distance 
    # Convert water level to mm
